...
import AllPatientsQuarterChart from "@/components/charts/apexcharts/ncdpplus/All/QuarterChart.vue";
import AllPatientsFacilityQuarterChart from "@/components/charts/apexcharts/ncdpplus/All/FacilityQuarterChart.vue";
    ...
    <Card class="border-0 shadow-sm">
        ...
        <CardContent class="pt-6 space-y-6">
            ...
            <div>
                ...
                <AllPatientsFacilityQuarterChart  
                    :data="props.patientData" 
                    :description="props.description"
                    class="border rounded-lg p-4 bg-gray-50"
                />
