...
import "./chunk-DZ5VRGCL.js";

// node_modules/ag-grid-vue3/dist/main.mjs
var N = Object.defineProperty;
var U = (r, d, e) => d in r ? N(r, d, { enumerable: true, configurable: true, writable: true, value: e }) : r[d] = e;
...
var R = class _R {
  ...
  static createAndMountComponent(d, e, n, s) {
    const t = _R.getComponentDefinition(d, n);
    if (!t)
      return;
  ...
  static mount(d, e, n, s) {
    ...
    return render(t, l), { vNode: t, destroy: () => {
      l && render(null, l), l = null, t = null;
    }, el: l };
  }
  static searchForComponentInstance(d, e, n = 10, s = false) {
...
var ge = class extends BaseComponentWrapper {
  constructor(e, n) {
    super();
    C(this, "parent");
    C(this, "provides");
...
var Ce = class extends VanillaFrameworkOverrides {
  constructor(e) {
    super("vue");
    C(this, "parent");
    this.parent = e;
  ...
  frameworkComponent(e, n) {
    let s = R.searchForComponentInstance(this.parent, e, 10, true) ? e : null;
    if (!s && n && n[e]) {
      const t = n[e];
      s = R.searchForComponentInstance(this.parent, t, 10, true) ? t : null;
    }
    return s;
  }
...
function v(r) {
  const d = (e) => we(e) ? toRaw(e) : Array.isArray(e) ? e.map((n) => d(n)) : isRef(e) || isReactive(e) || isProxy(e) ? d(toRaw(e)) : e;
  return d(r);
}
var ve = { ref: "root" };
var Fe = defineComponent({
  ...
  setup(r, { expose: d, emit: e }) {
    const n = r, s = useTemplateRef("root"), t = ref(void 0), l = ref(false), o = ref(false), i = ref(false), p = ref({}), c = ref(null), S = toRefs(n);
    _ALL_GRID_OPTIONS.filter((a) => a != "gridOptions").forEach((a) => {
      watch(
        () => S[a],
        (u, f) => {
          (a === "rowData" && !w.value || a !== "rowData") && P(a, u), w.value = false;
        },
        { deep: true }
      );
    });
    const h = /* @__PURE__ */ new Set(["rowDataUpdated", "cellValueChanged", "rowValueChanged"]), m = useModel(r, "modelValue"), F = ref(false), w = ref(false), G = e;
    watch(
      m,
      (a, u) => {
        l.value && (w.value || (F.value = true, P("rowData", v(a), v(u))), w.value = false);
      },
      { deep: true }
    );
    const E = he(() => {
      w.value = true, G("update:modelValue", V());
      ...
      if (o.value)
        return;
      u === "gridReady" && (i.value = true);
      const f = ALWAYS_SYNC_GLOBAL_EVENTS.has(u);
      f && !a || !f && a || h.has(u) && (F.value || I(u), F.value = false);
    }, P = (a, u, f) => {
      if (l.value) {
        let y = u.value || u;
    ...
    }, W = () => Object.create(getCurrentInstance().provides);
    return onMounted(() => {
      ModuleRegistry.registerModules([RowApiModule]);
      const a = new ge(getCurrentInstance(), W()), u = {
        globalListener: b(),
        globalSyncListener: b(true),
        frameworkOverrides: new Ce(getCurrentInstance()),
        providedBeanInstances: {
          frameworkCompWrapper: a
        },
        modules: n.modules
      }, f = markRaw(
        _combineAttributesAndGridOptions(v(n.gridOptions), n, [
          ..._ALL_GRID_OPTIONS,
          ..._ALL_EVENTS.map((z) => _getCallbackForEvent(z))
        ])
      ), y = L();
      y !== void 0 && (f.rowData = v(y)), t.value = createGrid(s.value, f, u), l.value = true;
    }), onUnmounted(() => {
      var a;
      l.value && ((a = t == null ? void 0 : t.value) == null || a.destroy(), o.value = true);
    }), d({
      api: t
    }), (a, u) => (openBlock(), createElementBlock("div", ve, null, 512));
  }
});
export {
  Fe as AgGridVue
